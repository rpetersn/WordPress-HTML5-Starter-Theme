		...
		<!-- custom scripts -->
		<script src="<?php echo get_template_directory_uri(); ?>/library/js/jquery.easing-1.3.pack.js"></script>
		<script src="<?php echo get_template_directory_uri(); ?>/library/js/jquery.fancybox-1.3.4.pack.js"></script>
        
		<script src="<?php echo get_template_directory_uri(); ?>/library/js/superfish.js"></script>
		<script src="<?php echo get_template_directory_uri(); ?>/library/js/jquery.hoverIntent.minified.js"></script>
